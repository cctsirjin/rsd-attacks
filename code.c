...
#define ATTACK_ROUNDS 3 // Effective when 3, 10, 20, etc. Times to attack the same index. Ideal to have larger ATTACK_ROUNDS (takes more time but statistically better).
