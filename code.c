...
#define ATTACK_ROUNDS 10 // Also effective when 12, 20. Times to attack the same index. Ideal to have larger ATTACK_ROUNDS (takes more time but statistically better).
...
#define CACHE_HIT_THRESHOLD 38 // Interval smaller than CACHE_HIT_THRESHOLD will be deemed as "cache hit". Ideal to have lower CACHE_HIT_THRESHOLD (higher accuracy).
