...
#define L1_DCACHE_WAYS 4 // Degree of associativity N = 4. i.e. 4-way set associative.
#define L1_DCACHE_BLOCK_BYTES 64 // b = 64Byte. "Fixed cache line length of 64 bytes."
#define L1_DCACHE_BLOCK_BITS 6 // = log2(b).
#define L1_DCACHE_SETS 128 // S = 128. S=B/N=C/Nb. Here C=32KiB, L1_DCACHE_WAYS=N=4, b=64B, so we have S=32KiB/(4x64B)=(1/8)K=128.
#define L1_DCACHE_SETS_BITS 7 // = log2(S)
#define L1_DCACHE_CAPACITY_BYTES (L1_DCACHE_SETS*L1_DCACHE_WAYS*L1_DCACHE_BLOCK_BYTES) // Cache Capacity C=Bb=SNb=0.5K*64Byte=32KiB
