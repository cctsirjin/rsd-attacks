...
#define L1_DCACHE_WAYS 8 // 4? Degree of associativity N = 4. i.e. N-way set associative.
#define L1_DCACHE_BLOCK_BYTES 64 // 128? b = 64Byte. "blockBytes" in https://github.com/chipsalliance/rocket-chip/blob/master/src/main/scala/rocket/DCACHE.scala
#define L1_DCACHE_BLOCK_BITS 6 // = log2(b).
#define L1_DCACHE_SETS 64 // S = 64. S=B/N=C/Nb. "nSets". Here C=32KiB, L1_DCACHE_WAYS=N=8, b=64B, so we have S=32KiB/(8x64B)=(1/2)K=64.
#define L1_DCACHE_SETS_BITS 6 // = log2(S)
#define L1_DCACHE_CAPACITY_BYTES (L1_DCACHE_SETS*L1_DCACHE_WAYS*L1_DCACHE_BLOCK_BYTES) // Cache Capacity C=Bb=SNb=64*4*128Byte=32KiB
