...
CFLAGS = -g -O0 -fno-stack-protector -fno-zero-initialized-in-bss -ffreestanding -fno-builtin -nostdlib -nodefaultlibs -nostartfiles -mstrict-align -march=rv32imf -mabi=ilp32f -I$(INC)
